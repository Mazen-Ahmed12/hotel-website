...
export const RoomsAndSuites = () => {
  ...
  return (
    <section className="bg-[#e9f0ec] dark:bg-gray-900 py-24 font-sans">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="w-1/2 mx-auto text-4xl md:text-5xl font-bold text-gray-800 dark:text-white mt-4">
